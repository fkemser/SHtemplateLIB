...
readonly LIB_SHTPL_DE_TXT_FILE_ALREADY_EXISTS="Datei existiert bereits oder Dateipfad ist ungültig"
readonly LIB_SHTPL_DE_TXT_FILE_NOT_FOUND="Datei nicht gefunden"
readonly LIB_SHTPL_DE_TXT_GOBACK="Zurück"
readonly LIB_SHTPL_DE_TXT_INVALID_ARG_1="Ungültiges Argument"
readonly LIB_SHTPL_DE_TXT_INVALID_ARG_2="für den Parameter"
...
readonly LIB_SHTPL_DE_TXT_REPEAT_ARG="Dieser Parameter kann mehrfach angegeben werden."
...
readonly LIB_SHTPL_DE_TXT_HELP_TXT_REQUIREMENTS_WSL_SYSTEMD="Bitte stellen Sie sicher, dass 'systemd' als System-/Sitzungsmanager aktiviert ist. Weitere Informationen finden Sie unter: https://learn.microsoft.com/de-de/windows/wsl/systemd"
